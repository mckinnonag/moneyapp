...
CREATE TABLE IF NOT EXISTS "transactions" (
  ...
  "plaid_item_id" int REFERENCES plaid_items (plaid_item_id),
  "user_id" int REFERENCES users (user_id),
  "category" text [],
  "location" varchar,
  "tx_name" varchar,
  "amount" float,
  "iso_currency_code" int REFERENCES currency_codes (code),
  "tx_date" timestamptz,
  "pending" boolean,
...
CREATE TABLE IF NOT EXISTS "plaid_items" (
    ...
    "access_token" varchar NOT NULL (250),
    "plaid_item_id" varchar NOT NULL (250), 
    "created_at" timestamptz NOT NULL DEFAULT (now())
);
